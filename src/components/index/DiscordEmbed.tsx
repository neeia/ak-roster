...
const DiscordEmbed = ((props: Props) => {
  ...
  return (
    ...
    >
      <Box sx={{ borderRadius: "50%", width: "3rem", height: "3rem" }} component="img" src="/res/kroos2ava.png" />
      ...
      <Box sx={{ borderRadius: "50%", width: "3rem", height: "3rem" }} component="img" src="/img/ext/icon_clyde_white_RGB.svg" />
    </Link>
  );
});
