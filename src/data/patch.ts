const patch = [
    ...
    title: "Images update && IS, RA Archive in Events Tacker",
    content: ["We've uploaded new images, new options to tracker"],
    changelog: [
      "Images updated upto to latest CN AK version (limited banner patch)",
      "Builder in Events Tracker now has all past IS and RA resources in batches to add to your planner. Check new data options in 'From'",
      "Fixes and tweaks:", 
      [
